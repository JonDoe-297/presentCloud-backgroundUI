  ...
  <el-card style="margin-bottom:20px;">
    ...
    <div class="user-profile">
      ...
      <div class="box-center">
        ...
        <div class="user-name text-center">{{ classData.username }}</div>
        <div class="user-role text-center text-muted">{{ classData.role }}</div>
      </div>
    </div>

    <div class="user-bio">
      <div class="user-education user-bio-section">
        <div class="user-bio-section-header"><svg-icon icon-class="user" /><span>工号</span></div>
